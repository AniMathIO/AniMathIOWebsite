    ...
    const installButtons = [
        {
            ...
            platform: "Windows",
            installLink: "https://github.com/AniMathIO/AniMathIO/releases/download/v1.3.1/AniMathIO.Setup.1.3.1.exe",
            isDisabled: false,
        },
        {
            ...
            installLink: "https://github.com/AniMathIO/AniMathIO/releases/download/v1.3.1/AniMathIO-1.3.1.AppImage",
            isDisabled: false,
        },
        {
            imageUrl: "./img/tux.svg",
            altText: "Install on Linux icon",
            platform: "Linux (Snap)",
            installLink: "https://github.com/AniMathIO/AniMathIO/releases/download/v1.3.1/animathio_1.3.1_amd64.snap",
            isDisabled: false,
        },
        {
